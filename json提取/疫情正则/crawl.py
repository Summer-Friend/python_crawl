'''
@Author: your name
@Date: 2020-03-01 14:23:12
@LastEditTime: 2020-03-01 15:52:30
@LastEditors: Please set LastEditors
@Description: In User Settings Edit
@FilePath: \vscode_code\爬虫测试\json提取\疫情正则\crawl.py
'''
#好啊吧，我承认这一天我太无聊了水着玩的
import requests
import re
...
def parse_one_page(html):
    ...
    csv_file = open(r'E:\vscode_code\爬虫测试\json提取\疫情正则\yiqing_1.csv', 'a+', newline='', encoding='utf-8-sig')  # 解决中文乱码问题
