'''
@Author: your name
@Date: 2020-03-05 09:56:40
@LastEditTime: 2020-03-08 10:17:33
@LastEditors: Please set LastEditors
@Description: In User Settings Edit
@FilePath: \vscode_code\爬虫测试\反爬虫\其他\1.py
'''
#可参照：E:\vscode_code\GitHub项目\interesting_python\盲僧招聘
#那个是根据xpath做的，解密已经提前做好了
import requests,json,re
#这里用TTFont貌似只是转存为了xml文件，这个用font.getGlyphOrder()解析也行，但是内容多了可能慢一些
...
def initialize_woff():
    while True:
        try:
            ...
            #原始匹配数据：[('(/interns/iconfonts/file?rand=0.16423818208757135)', '(/interns/iconfonts/file?rand=0.16423818208757135)')]
            ...
            with open(r'E:\vscode_code\爬虫测试\反爬虫\其他\字体.woff', 'wb')as f:
                f.write(wofffile.content)
            font1 = TTFont(r'E:\vscode_code\爬虫测试\反爬虫\其他\字体.woff')
            font1.saveXML(r'E:\vscode_code\爬虫测试\反爬虫\其他\字体.xml')
            break
