'''
@Author: your name
@Date: 2020-03-08 13:42:57
@LastEditTime: 2020-03-08 13:47:22
@LastEditors: Please set LastEditors
@Description: In User Settings Edit
@FilePath: \vscode_code\练习\58\3.py
'''
import requests
import re
import os
...
class MaoYan(object):
    ...
    def create_font(self, font_file):
        # 列出已下载文件
        file_list = os.listdir(r'E:\vscode_code\练习\58')
        # 判断是否已下载
        if font_file not in file_list:
            ...
            with open(r'E:\vscode_code\练习\58\\' + font_file, 'wb') as f:
                f.write(new_file)

        # 打开字体文件，创建 self.font属性
        self.font = TTFont(r'E:\vscode_code\练习\58\\' + font_file)
